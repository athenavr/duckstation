...
static const SettingInfo s_settings[] = {
  ...
  {SettingInfo::Type::Float, "LLinearity", TRANSLATE_NOOP("NeGcon", "Left Trigger Linearity"),
   ...
   nullptr, 1.0f},
  {SettingInfo::Type::Float, "SteeringZero", TRANSLATE_NOOP("NeGcon", "Advanced Steering Zero"),
   TRANSLATE_NOOP("NeGcon", "Sets zero for steering axis."), "128.0f", "0.0f", "255.0f", "0.5f", "%.1f",
   nullptr, 1.0f},
  {SettingInfo::Type::Float, "SteeringScaling", TRANSLATE_NOOP("NeGcon", "Advanced Steering Scaling"),
   TRANSLATE_NOOP("NeGcon", "Sets scaling for steering axis."), "127.0f", "-2000.0f", "2000.0f", "0.5f", "%.1f",
   nullptr, 1.0f},
  {SettingInfo::Type::Float, "IZero", TRANSLATE_NOOP("NeGcon", "Advanced I Zero"),
   TRANSLATE_NOOP("NeGcon", "Sets zero for button I."), "0.0f", "0.0f", "255.0f", "0.5f", "%.1f",
   nullptr, 1.0f},
  {SettingInfo::Type::Float, "IScaling", TRANSLATE_NOOP("NeGcon", "Advanced I Scaling"),
   TRANSLATE_NOOP("NeGcon", "Sets scaling for button I."), "255.0f", "-2000.0f", "2000.0f", "0.5f", "%.1f",
   nullptr, 1.0f},
  {SettingInfo::Type::Float, "IIZero", TRANSLATE_NOOP("NeGcon", "Advanced II Zero"),
   TRANSLATE_NOOP("NeGcon", "Sets zero for button II."), "0.0f", "0.0f", "255.0f", "0.5f", "%.1f",
   nullptr, 1.0f},
  {SettingInfo::Type::Float, "IIScaling", TRANSLATE_NOOP("NeGcon", "Advanced II Scaling"),
   TRANSLATE_NOOP("NeGcon", "Sets scaling for button II."), "255.0f", "-255.0f", "255.0f", "0.5f", "%.1f",
   nullptr, 1.0f},
  {SettingInfo::Type::Float, "LZero", TRANSLATE_NOOP("NeGcon", "Advanced Left Trigger Zero"),
   TRANSLATE_NOOP("NeGcon", "Sets zero for button left trigger."), "0.0f", "0.0f", "255.0f", "0.5f", "%.1f",
   nullptr, 1.0f},
  {SettingInfo::Type::Float, "LScaling", TRANSLATE_NOOP("NeGcon", "Advanced Left Trigger Scaling"),
   TRANSLATE_NOOP("NeGcon", "Sets scaling for button left trigger."), "255.0f", "-2000.0f", "2000.0f", "0.5f", "%.1f",
   nullptr, 1.0f},
};
